...
export const env = {
  ...
  authCookieName: process.env.AUTH_COOKIE_NAME ?? 'agent_auth',
  authCookieMaxAgeMs: parseIntegerEnv(process.env.AUTH_COOKIE_MAX_AGE_MS, 7 * 24 * 60 * 60 * 1000),
  maxFailedLoginAttempts: parseIntegerEnv(process.env.MAX_FAILED_LOGIN_ATTEMPTS, 5),
